...
import filterFactory, {
  textFilter, selectFilter, numberFilter, customFilter,
...
class DataTable extends React.Component {
    ...
    renderExportCSVButton = () => (
      ...
      >
        <span className="export-icon"><b /></span>
Export
      </button>
    );
        ...
        <div className="table-button-menu">
          ...
          {filtersType === 'shown'
                && (
                  ...
                  >
                    <span class="filter-icon filter-icon-shown"><b /></span>
Filter
                  </button>
                )
          }
          {filtersType === 'filtered'
                && (
                  ...
                  >
                    <span class="filter-icon filter-icon-clear"><b /></span>
Clear Filters
                  </button>
                )
          }
...
Filter
    ...
    renderShowsTotal = (start, to, total) => (
      <div style={{
        float: 'right', fontSize: '10px', marginTop: '4px', marginRight: '-66px',
      }}
      >
            Showing
        {' '}
